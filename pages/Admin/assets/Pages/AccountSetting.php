                ...
                <div class="table-responsive" id="showAllUsers">
                    ...
                    <tr>
                        ...
                        <td class="col-5 text-center">
                         <input type="text" name="name" size="45" value="Admin" readonly/>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn" data-toggle="tooltip" data-placement="top" title="Enter valid email">
                                <input type="text" name="email" size="45" value="<?php if(isset($adminEmail)){echo $adminEmail;} ?>"/>
                            </button>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn" data-toggle="tooltip" data-placement="top" title="Password Must be greter than or equal,must Contain At Least 1 Number,Capital Letter and Lowercase Letter">
                                <input type="password" name="pw" size="45" value="<?php if(isset($adminPw)){echo $adminPw;} ?>"/>
                            </button>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="password" name="Rpw" size="45" value="<?php if(isset($adminPw)){echo $adminPw;} ?>"/>
                            </button>
                        </td>
